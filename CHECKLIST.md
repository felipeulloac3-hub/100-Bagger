...
**Version 0.4** — 153 questions across 11 stages.
...
Every question is marked with where it comes from. BOOK: the named source wrote this question, in these words or close to them, in a published book, letter or research paper - the highest-confidence attribution. TALK: the source asked it in a recorded lecture, interview or podcast; his words, but transcribed rather than authored, so the phrasing is approximate. DERIVED: the source described the principle or the failure mode, and the question is my operationalization of it - it carries no borrowed authority and should be argued with on its own merits. Nothing here is a leaked private checklist.

**51 from published text, 12 from recorded talks, 90 derived.**
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 1.1 | Do I understand this business - can I explain how it makes money in two minutes? | BUFFETT · LYNCH | **book** | `H` | GATE |
| 1.2 | Does it have favorable long-term economics that are durable? | BUFFETT | **book** | `H` | GATE |
| 1.3 | Is management able **and** trustworthy? Both, not either. | BUFFETT | **book** | `H` | GATE |
| 1.4 | Is the price sensible relative to what I am getting? | BUFFETT | **book** | `M+H` | MAJOR |
| 1.5 | **Which of Phelps' four routes is this?** Commodity re-rating, capital-structure leverage, inflation leverage, or reinvestment at high ROIC? | PHELPS | **book** | `H` | GATE |
| 1.6 | **Which of Lynch's six categories is this?** Slow grower, stalwart, fast grower, cyclical, turnaround, or asset play? | LYNCH | **book** | `H` | GATE |
| 1.7 | **Which of Leonard's quadrants?** No moat, legacy moat, capital-light compounder, or reinvestment moat? | LEONARD | **book** | `H` | MAJOR |
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 2.1 | Is ROIC/ROCE high **and** predictable across a full cycle, not one good year? | AKRE · SMITH · MAYER | **talk** | `M` | MAJOR |
| 2.2 | Is there a reinvestment moat - can incremental capital be deployed at a similar rate? | AKRE · LEONARD | **talk** | `M+H` | MAJOR |
...
| 2.5 | Is growth in the 20-25% band? Faster than 30% brings problems; slower takes too long. | MAYER | **book** | `M` | MAJOR |
...
| 2.8 | Is this a fertile field - an industry in a long secular expansion rather than a one-cycle boom? | PRICE | **book** | `H` | MAJOR |
| 2.9 | Will management develop new products when current lines mature? | FISHER #2 | **book** | `H` | MAJOR |
| 2.10 | Is cash conversion (FCF ÷ net income) consistently near or above 1? | SMITH | **book** | `M` | MAJOR |
| 2.11 | Is the gross margin worthwhile in absolute terms? | FISHER #5 · SMITH | **book** | `M` | MAJOR |
| 2.12 | What is the company actively doing to maintain or improve margins? | FISHER #6 | **book** | `H` | MINOR |
| 2.13 | Is growth organic, or a roll-up dependent on continued acquisition? | SMITH · MAYER | *derived* | `M` | MAJOR |
| 2.14 | Is R&D productive relative to the company's size? | FISHER #3 | **book** | `M+H` | MINOR |
| 2.15 | Is there an above-average sales organization? | FISHER #4 | **book** | `H` | MINOR |
...
| 2.19 | What is peculiar to this industry that reveals how it stands against competitors? | FISHER #11 | **book** | `H` | MINOR |
| 2.20 | What do **normalized earnings** look like through a full cycle, stripped of one-time items? | PABRAI | **talk** | `M+H` | MAJOR |
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 3.1 | Am I buying at a depressed multiple that can expand as the business is discovered? | DAVIS | **book** | `M+H` | MAJOR |
| 3.2 | Is PEG - P/E divided by **earnings** growth - not much above 1? | MAYER | **book** | `M` | MAJOR |
| 3.3 | What growth and duration does the current price already imply? Run the reverse DCF. | MAUBOUSSIN | *derived* | `M` | MAJOR |
| 3.4 | Is the implied competitive advantage period plausible against the fade base rate (~0.79 annual persistence)? | MAUBOUSSIN | **book** | `M+H` | MAJOR |
| 3.5 | Is the multiple depressed for a *temporary* reason or a *permanent* one? | DAVIS · TEMPLETON | *derived* | `H` | MAJOR |
| 3.6 | Is sentiment at or near a point of maximum pessimism for this name or its sector? | TEMPLETON | **book** | `H` | MINOR |
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 4.1 | Which specific moat source applies - network effects, switching costs, cost advantage, intangibles, efficient scale? | GREENWALD | **book** | `H` | MAJOR |
| 4.2 | Is the moat widening or narrowing? What is the evidence in the numbers? | BUFFETT | **talk** | `M+H` | MAJOR |
| 4.3 | What specifically prevents ROIC fade here, against a base rate that says it should fade? | MAUBOUSSIN | *derived* | `H` | MAJOR |
| 4.4 | Is capital entering or leaving this industry? Capital exiting is the bullish signal. | MARATHON | **book** | `M+H` | MAJOR |
| 4.5 | Are competitors adding capacity, and is the industry consolidating or fragmenting? | MARATHON | *derived* | `M+H` | MAJOR |
| 4.6 | Does high ROIC plus heavy investment here advertise the opportunity to competitors? | MAUBOUSSIN | **book** | `H` | MAJOR |
...
| 4.11 | Does the company share scale economies with customers, deepening advantage as it grows? | SLEEP | **book** | `H` | MAJOR |
| 4.12 | Is the advantage a genuine 10x - proprietary technology, network effect, scale, brand - or merely incremental? | THIEL | **book** | `H` | MAJOR |
...
| 4.16 | Does it dominate a niche that is itself expanding? | LYNCH · CASSEL | **book** | `H` | MAJOR |
| 4.17 | Would this business still exist in recognizable form in 20 years? | PHELPS · KIRBY | *derived* | `H` | MAJOR |
| 4.18 | Is the business vulnerable to low-cost foreign competition or manufacturing imitation? | PABRAI | **talk** | `H` | MAJOR |
| 4.19 | Is the business reliant on organized labor that could halt operations over wage disputes? | PABRAI | **talk** | `H` | MINOR |
| 4.20 | Does the sector face environmental or regulatory crackdowns that could freeze operations? | PABRAI | **talk** | `H` | MINOR |
...
| 5.2 | Is debt recourse to the parent, and cross-defaulted across subsidiaries? | PABRAI | **talk** | `M+H` | MAJOR |
...
| 5.9 | Will growth require equity financing that cancels the benefit of that growth to existing holders? | FISHER #13 · CASSEL | **book** | `M+H` | MAJOR |
...
| 6.2 | Did they buy shares with their own money, or were the shares granted? | LYNCH #12 | **book** | `M` | MAJOR |
| 6.3 | Does management have the **capacity to suffer** - will they depress reported earnings today to build the franchise? | RUSSO | **talk** | `H` | MAJOR |
...
| 6.5 | Does the business have the capacity to *absorb* capital internally, so cash need not find another home? | RUSSO · AKRE | **talk** | `M+H` | MAJOR |
| 6.6 | Has the senior team been together for a meaningful period? | PABRAI | **talk** | `M+H` | MAJOR |
| 6.7 | Would the death or departure of the CEO materially impair the business? | PABRAI | **talk** | `H` | MAJOR |
| 6.8 | Is there management depth, or one person and a layer of assistants? | FISHER #9 | **book** | `H` | MAJOR |
| 6.9 | Does management speak as freely about problems as about successes? | FISHER #14 | **book** | `M+H` | MAJOR |
| 6.10 | Is management's integrity beyond question? | FISHER #15 · BUFFETT | **book** | `H` | GATE |
| 6.11 | Does the CEO behave like a capital allocator - per-share value rather than size? | THORNDIKE | **book** | `H` | MAJOR |
| 6.12 | Were buybacks executed when the stock was cheap, or when it was expensive? | THORNDIKE · LYNCH #13 | **book** | `M` | MAJOR |
...
| 6.17 | Are labor and personnel relations outstanding? | FISHER #7 | **book** | `H` | MINOR |
| 6.18 | Are relations *within* the executive group sound? | FISHER #8 | **book** | `H` | MINOR |
| 6.19 | Are cost analysis and accounting controls good enough to know unit economics? | FISHER #10 | **book** | `H` | MAJOR |
| 6.20 | Will management sacrifice short-term profit for long-term position? | FISHER #12 | **book** | `H` | MAJOR |
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 8.1 | Does it sound dull, or better still, ridiculous? | LYNCH #1 | **book** | `H` | MINOR |
| 8.2 | Does it do something dull, disagreeable, or faintly depressing? | LYNCH #2,3,7 | **book** | `H` | MINOR |
| 8.3 | Is it a spin-off - an orphan nobody was given a reason to hold? | LYNCH #4 · GREENBLATT | **book** | `M` | MINOR |
| 8.4 | Do institutions not own it and analysts not cover it? | LYNCH #5 · CASSEL | **book** | `M` | MAJOR |
| 8.5 | Is it a good company inside a no-growth industry? | LYNCH #8 | **book** | `H` | MINOR |
| 8.6 | Do people have to keep buying it - is the purchase recurring rather than one-off? | LYNCH #10 | **book** | `H` | MAJOR |
| 8.7 | Is it a *user* of technology rather than a maker of it? | LYNCH #11 | **book** | `H` | MINOR |
...
| # | Question | Source | Provenance | Type | Weight |
|---|---|---|---|---|---|
| 9.1 | Am I committed to this because I have researched it for weeks? Commitment and consistency. | MUNGER · PABRAI | **book** | `H` | MAJOR |
| 9.2 | Am I buying because a respected investor owns it? Social proof. | MUNGER · PABRAI | **book** | `H` | MAJOR |
| 9.3 | Have I written the bear case myself, in its strongest form? | SPIER | *derived* | `H` | MAJOR |
| 9.4 | Whose incentives shaped the research I have read? | MUNGER | **book** | `H` | MAJOR |
| 9.5 | Am I anchored to a past price rather than to value? | MUNGER | **book** | `H` | MINOR |
| 9.6 | Am I confusing a low share price with a low valuation? | LYNCH | *derived* | `H` | MINOR |
| 9.7 | Would I buy this if the market closed for ten years? | BUFFETT · SPIER | **book** | `H` | MAJOR |
...
| 10.4 | Do I accept Phelps' standard - that a sale is a confession of an error? | PHELPS | **book** | `H` | MAJOR |
| 10.5 | Would I be content if I could not touch this position for ten years? | KIRBY · MAYER | **book** | `H` | MAJOR |
